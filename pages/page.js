...
var template = function(name, body) {
  document.body.innerHTML = '<head> <link href="https://cdn.jsdelivr.net/npm/remixicon@2.5.0/fonts/remixicon.css" rel="stylesheet"> <title>'+ name +' - ScratchRemix</title><link rel="stylesheet" href="pages/page.css"></head><body><div class="dash">&nbsp; <b>ScratchRemix</b>&nbsp;&nbsp;&nbsp; <a href="https://scratchremix.github.io/">Home</a> <div class="dropdown" style=""> <button class="dropbtn">Links</button> <div class="dropdown-content" style="left:0;"> <a href="AssetLoader">Asset Loader</a> <a href="https://github.com/ScratchRemix/">Github</a> <a href="https://github.com/Daniel4-Scratch" class="b e">Daniel4-Scratch</a> </div> </div> <div class="dropdown" style=""> <button class="dropbtn">Tools</button> <div class="dropdown-content" style="left:0;"> <a href="AssetLoader"><i class="ri-list-unordered"></i> Asset Loader</a> <a href="Editor" class="b"><i class="ri-pencil-fill"></i> Editor</a> </div> </div> <span class="dash">&nbsp;</span> <div class="f"> <a class="white" style="float:right;" href="https://github.com/scratchremix" target="_blank">Github</a> <span style="float:right;">&nbsp</span> </div> </div><div class="te">'+
  body + '</div></body>';
